              ...
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['monthlyAllocation']
                          as _i11.MonthlyAllocationEndpoint)
                      .upsert(
                        session,
                        params['envelopeId'],
                        params['budgetId'],
        ...
        'create': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['payee'] as _i12.PayeeEndpoint).create(
                session,
                params['name'],
                params['budgetId'],
              ),
        ...
        'list': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['payee'] as _i12.PayeeEndpoint).list(
                session,
                params['budgetId'],
              ),
        ),
        'get': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['payee'] as _i12.PayeeEndpoint).get(
                session,
                params['payeeId'],
              ),
        ),
        'update': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['payee'] as _i12.PayeeEndpoint).update(
                session,
                params['payeeId'],
                name: params['name'],
              ),
        ...
        'delete': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['payee'] as _i12.PayeeEndpoint).delete(
                session,
                params['payeeId'],
              ),
        ),
