...
- #165: In progress: extracted interpreter module + added fixture-style unit tests across multiple protocol patterns (Jupiter, Pump.fun, directional SOL transfer, generic fallback, provider-direct descriptions); deeper protocol templates (Raydium/Orca/NFT marketplaces with richer amount context) are still pending.
