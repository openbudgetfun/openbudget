...
const accountSettingsRoute = 'accountSettings';
const accountSettingsPath = '/budgets/:id/more/settings/account-settings';
const deleteAccountRoute = 'deleteAccount';
const deleteAccountPath = '/budgets/:id/more/settings/account-settings/delete';
