...
import 'solana_wallets/solana_wallet.dart' as _i11;
import 'solana_wallets/solana_wallet_holding.dart' as _i12;
import 'solana_wallets/solana_wallet_sync_result.dart' as _i13;
import 'solana_wallets/solana_wallet_tax_year_summary.dart' as _i14;
import 'solana_wallets/solana_wallet_transaction.dart' as _i15;
import 'transaction_rules/transaction_rule.dart' as _i16;
import 'transactions/import_row.dart' as _i17;
import 'transactions/split_item.dart' as _i18;
import 'transactions/transaction.dart' as _i19;
import 'package:openbudget_client/src/protocol/accounts/account.dart' as _i20;
...
import 'package:openbudget_client/src/protocol/monthly_allocations/monthly_allocation.dart'
    as _i22;
import 'package:openbudget_client/src/protocol/budgets/budget.dart' as _i23;
...
import 'package:openbudget_client/src/protocol/envelope_goals/envelope_goal.dart'
    as _i25;
import 'package:openbudget_client/src/protocol/envelopes/envelope.dart' as _i26;
import 'package:openbudget_client/src/protocol/payees/payee.dart' as _i27;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i11.SolanaWallet) {
      return _i11.SolanaWallet.fromJson(data) as T;
    }
    if (t == _i12.SolanaWalletHolding) {
      return _i12.SolanaWalletHolding.fromJson(data) as T;
    }
    if (t == _i13.SolanaWalletSyncResult) {
      return _i13.SolanaWalletSyncResult.fromJson(data) as T;
    }
    if (t == _i14.SolanaWalletTaxYearSummary) {
      return _i14.SolanaWalletTaxYearSummary.fromJson(data) as T;
    }
    if (t == _i15.SolanaWalletTransaction) {
      return _i15.SolanaWalletTransaction.fromJson(data) as T;
    }
    if (t == _i16.TransactionRule) {
      return _i16.TransactionRule.fromJson(data) as T;
    }
    if (t == _i17.ImportRow) {
      return _i17.ImportRow.fromJson(data) as T;
    }
    if (t == _i18.SplitItem) {
      return _i18.SplitItem.fromJson(data) as T;
    }
    if (t == _i19.Transaction) {
      return _i19.Transaction.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i11.SolanaWallet?>()) {
      return (data != null ? _i11.SolanaWallet.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i12.SolanaWalletHolding?>()) {
      return (data != null ? _i12.SolanaWalletHolding.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i13.SolanaWalletSyncResult?>()) {
      return (data != null ? _i13.SolanaWalletSyncResult.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i14.SolanaWalletTaxYearSummary?>()) {
      return (data != null
              ? _i14.SolanaWalletTaxYearSummary.fromJson(data)
              : null)
          as T;
    }
    if (t == _i1.getType<_i15.SolanaWalletTransaction?>()) {
      return (data != null ? _i15.SolanaWalletTransaction.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i16.TransactionRule?>()) {
      return (data != null ? _i16.TransactionRule.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i17.ImportRow?>()) {
      return (data != null ? _i17.ImportRow.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i18.SplitItem?>()) {
      return (data != null ? _i18.SplitItem.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i19.Transaction?>()) {
      return (data != null ? _i19.Transaction.fromJson(data) : null) as T;
    }
    if (t == List<_i20.Account>) {
      return (data as List).map((e) => deserialize<_i20.Account>(e)).toList()
          as T;
    }
    if (t == List<_i21.BudgetTemplate>) {
      return (data as List)
              .map((e) => deserialize<_i21.BudgetTemplate>(e))
              .toList()
          as T;
    }
    if (t == List<_i22.MonthlyAllocation>) {
      return (data as List)
              .map((e) => deserialize<_i22.MonthlyAllocation>(e))
              .toList()
          as T;
    }
    if (t == List<_i23.Budget>) {
      return (data as List).map((e) => deserialize<_i23.Budget>(e)).toList()
          as T;
    }
    ...
    if (t == List<_i25.EnvelopeGoal>) {
      return (data as List)
              .map((e) => deserialize<_i25.EnvelopeGoal>(e))
              .toList()
          as T;
    }
    if (t == List<_i26.Envelope>) {
      return (data as List).map((e) => deserialize<_i26.Envelope>(e)).toList()
          as T;
    }
    if (t == List<String>) {
      return (data as List).map((e) => deserialize<String>(e)).toList() as T;
    }
    if (t == List<_i27.Payee>) {
      return (data as List).map((e) => deserialize<_i27.Payee>(e)).toList()
          as T;
    }
    if (t == List<_i28.RecurringTransaction>) {
      return (data as List)
              .map((e) => deserialize<_i28.RecurringTransaction>(e))
              .toList()
          as T;
    }
    ...
    if (t == List<_i30.SolanaWalletTransaction>) {
      return (data as List)
              .map((e) => deserialize<_i30.SolanaWalletTransaction>(e))
              .toList()
          as T;
    }
    if (t == List<_i31.SolanaWalletHolding>) {
      return (data as List)
              .map((e) => deserialize<_i31.SolanaWalletHolding>(e))
              .toList()
          as T;
    }
    if (t == List<_i32.SolanaWalletTaxYearSummary>) {
      return (data as List)
              .map((e) => deserialize<_i32.SolanaWalletTaxYearSummary>(e))
              .toList()
          as T;
    }
    if (t == List<_i33.TransactionRule>) {
      return (data as List)
              .map((e) => deserialize<_i33.TransactionRule>(e))
              .toList()
          as T;
    }
    if (t == List<_i34.Transaction>) {
      return (data as List)
              .map((e) => deserialize<_i34.Transaction>(e))
              .toList()
          as T;
    }
    if (t == List<int>) {
    ...
    if (t == List<_i35.SplitItem>) {
      return (data as List).map((e) => deserialize<_i35.SplitItem>(e)).toList()
          as T;
    }
    if (t == List<_i36.ImportRow>) {
      return (data as List).map((e) => deserialize<_i36.ImportRow>(e)).toList()
          as T;
    }
    try {
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i11.SolanaWallet => 'SolanaWallet',
      _i12.SolanaWalletHolding => 'SolanaWalletHolding',
      _i13.SolanaWalletSyncResult => 'SolanaWalletSyncResult',
      _i14.SolanaWalletTaxYearSummary => 'SolanaWalletTaxYearSummary',
      _i15.SolanaWalletTransaction => 'SolanaWalletTransaction',
      _i16.TransactionRule => 'TransactionRule',
      _i17.ImportRow => 'ImportRow',
      _i18.SplitItem => 'SplitItem',
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i11.SolanaWallet():
        return 'SolanaWallet';
      case _i12.SolanaWalletHolding():
        return 'SolanaWalletHolding';
      case _i13.SolanaWalletSyncResult():
        return 'SolanaWalletSyncResult';
      case _i14.SolanaWalletTaxYearSummary():
        return 'SolanaWalletTaxYearSummary';
      case _i15.SolanaWalletTransaction():
        return 'SolanaWalletTransaction';
      case _i16.TransactionRule():
        return 'TransactionRule';
      case _i17.ImportRow():
        return 'ImportRow';
      case _i18.SplitItem():
        return 'SplitItem';
      case _i19.Transaction():
        return 'Transaction';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'SolanaWallet') {
      return deserialize<_i11.SolanaWallet>(data['data']);
    }
    if (dataClassName == 'SolanaWalletHolding') {
      return deserialize<_i12.SolanaWalletHolding>(data['data']);
    }
    if (dataClassName == 'SolanaWalletSyncResult') {
      return deserialize<_i13.SolanaWalletSyncResult>(data['data']);
    }
    if (dataClassName == 'SolanaWalletTaxYearSummary') {
      return deserialize<_i14.SolanaWalletTaxYearSummary>(data['data']);
    }
    if (dataClassName == 'SolanaWalletTransaction') {
      return deserialize<_i15.SolanaWalletTransaction>(data['data']);
    }
    if (dataClassName == 'TransactionRule') {
      return deserialize<_i16.TransactionRule>(data['data']);
    }
    if (dataClassName == 'ImportRow') {
      return deserialize<_i17.ImportRow>(data['data']);
    }
    if (dataClassName == 'SplitItem') {
      return deserialize<_i18.SplitItem>(data['data']);
    }
    if (dataClassName == 'Transaction') {
      return deserialize<_i19.Transaction>(data['data']);
    }
